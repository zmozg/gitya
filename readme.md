...
Хорошим тоном является составление правил написания коммитов. Например:
- длина сообщения от 30 до 72 символов;
- первое слово — глагол в инфинитиве («исправить», «дополнить», «добавить» и другие);
- формат коммита: `<type>: <сообщение>` type(1. feat *новая фича*, 2. fix *исправление*)

В GitHub можно вести список **задач** (англ. _issue_) проекта. Если коммит «закрывает» какую-то задачу, то в его сообщении удобно указывать  `#<номер задачи>`. Например, вот так.
